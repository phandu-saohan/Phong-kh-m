...
const App: React.FC = () => {
    ...
    const renderView = () => {
        ...
        switch (view.name) {
            ...
            case 'customer-detail': return <CustomerDetail customer={view.data} onBack={() => handleNavigate('customers')} onUpdateCustomer={handleUpdateCustomer} appointments={appointments} permissions={userPermissions} />;
